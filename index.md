...
<button name="btn" onclick="https://huggingface.co/datasets/PiC/phrase_similarity">Explore PS</button>
...
<button name="btn" onclick="https://huggingface.co/datasets/PiC/phrase_retrieval">Explore PR</button>
...
<button name="btn" onclick="https://huggingface.co/datasets/PiC/phrase_sense_disambiguation">Explore PSD</button>
